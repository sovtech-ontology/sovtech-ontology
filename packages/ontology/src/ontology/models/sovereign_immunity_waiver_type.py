...
def _object_meta() -> ObjectMeta:
    return ObjectMeta(
        type_="SovereignImmunityWaiverType",
        description=(
            "The extent of a sovereign immunity waiver: full, none, or selective."
        ),
        named_individuals=named_individuals,
    )


class SovereignImmunityWaiverType(BaseResource):
    """The extent of a sovereign immunity waiver: full, none, or
    selective."""
    ...
    id: Annotated[AnyUrl, named_individual_iri_enum("SovereignImmunityWaiverType")] = (
        Field(alias="@id")
    )
    type_: Literal["SovereignImmunityWaiverType"] = Field(alias="@type")
