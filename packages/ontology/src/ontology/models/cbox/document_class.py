...
def _object_meta() -> ObjectMeta:
    return ObjectMeta(
        type_="DocumentClass",
        description=(
            "A classification of corpus documents by form. Unclassified is "
            "the absence of a document class, never an individual."
        ),
        named_individuals=named_individuals,
    )


class DocumentClass(BaseResource):
    """A classification of corpus documents by form. Unclassified is the
    absence of a document class, never an individual."""
    ...
    id: Annotated[Iri, named_individual_iri_enum("DocumentClass")] = Field(alias="@id")
    type_: Literal["DocumentClass"] = Field(alias="@type")
