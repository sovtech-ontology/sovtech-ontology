...
The SovTech Ontology (SVTO) describes sovereign debt instruments, the agreements that govern them, their contract provisions, the parties that hold roles on them, and the documents that disclose them. It expresses them as linked data built on semantic web technology: [RDF](https://www.w3.org/TR/rdf11-concepts/) as the data model, with [SKOS](https://www.w3.org/TR/skos-reference/) and [schema.org](https://schema.org) as vocabularies.

The SVTO interchange format follows the pattern of [`@wpg/model`](https://github.com/DataEcosystems/WickedProblemGovernance/tree/main/packages/model) from the [WickedProblemGovernance](https://github.com/DataEcosystems/WickedProblemGovernance) repository.
